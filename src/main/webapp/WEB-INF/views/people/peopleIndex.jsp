...
//			  ,width: '100%'	//默认自动调整
			  ...
			  ,url: '/jfinal-frame/people/list'	//异步获取数据
			  ,cols: [[
		    ...
		    if(obj.event === 'del'){//删除
		      layer.confirm('是否确认删除？', function(index){
		        ...
		        layer.open({
		          ...
		          ,maxmin: true
		          ,offset: [50,0] //模态框坐标
		          ,content: '/jfinal-frame/people/detail?id='+data.id
		         /*  ,btn: ['保存', '关闭'] //只是为了演示
			...
			batchDel: function(){ //批量删除
		  	...
		  	addData: function(){
		        layer.open({
			          ...
			          ,maxmin: true
			          ,offset: [50,0] //模态框坐标
			          ,content: '/jfinal-frame/people/detail'
			        });
		  	}
		    ,reload: function(){
